...
class _189_rotatedArray {
    /*
     * (Easy) Description Given a string(Given in the way of char array) and an
     * offset, rotate the string by offset in place. (rotate from left to right).
